...
![2-way external merge sort](<../.gitbook/assets/image (14).png>)
...
![Clustered B+Tree](<../.gitbook/assets/image (2).png>)

_Case #2 - Unclustered B+Tree_

需要追随指针来找目标数据所在页，一个bad idea，每条数据都有可能引发I/O开销

![Unclustered B+Tree](<../.gitbook/assets/image (5).png>)
...
![Sorting Aggregation](<../.gitbook/assets/image (15).png>)
